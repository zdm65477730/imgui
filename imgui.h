...
struct ImFontAtlas
{
    ...
    IMGUI_API const ImWchar*    GetGlyphRangesChineseTraditionalCommon();// Default + Half-Width + Japanese Hiragana/Katakana + set of 2500 CJK Unified Ideographs for common traditional Chinese
